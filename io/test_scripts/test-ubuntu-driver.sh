...
pip install --upgrade --upgrade-strategy eager impyla[kerberos]==0.17.0

# pip3 install --upgrade --upgrade-strategy eager "$thrift_whl"
# pip3 install --upgrade --upgrade-strategy eager "$impyla_whl"[kerberos]
pip3 install --upgrade --upgrade-strategy eager impyla[kerberos]==0.17.0

python /io/test_scripts/test-impala-py2-ldap.py
python3 /io/test_scripts/test-impala-py3-ldap.py

python /io/test_scripts/test-hive-py2-ldap.py
python3 /io/test_scripts/test-hive-py3-ldap.py
